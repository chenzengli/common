...
import com.mc.common.BuildConfig;
import com.mc.common.R;
import com.mc.common.constant.Constant;
import com.mc.common.util.AppUtil;
...
/**
 * Created by Genuis on 2017/10/23.
 */
...
//                .addInterceptor(buildTokenInterceptor())                // 添加token拦截器
                ...
                .connectTimeout(8, TimeUnit.SECONDS)                     // 8秒连接超时
    ...
    private static Cache getCache() {
        // 获取缓存目标,SD卡
        File cacheFile = new File(AppUtil.getContext().getCacheDir(), AppUtil.getContext().getString(R.string.app_name));
        // 创建缓存对象,最大缓存50m
